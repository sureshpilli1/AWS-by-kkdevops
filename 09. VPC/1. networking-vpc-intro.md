...
How Does the First Octet Determine the Class?
The first few bits of the first octet identify the class.
...
Example:
239.1.1.1
One sender can transmit to many receivers.
...
Why Classes Are Mostly Historical Today
Modern networks use:
...
10.0.0.0/20
172.16.0.0/18
Instead of relying on Class A/B/C.
CIDR allows much more efficient use of IP addresses.
